---
name: telegram
description: Work with the personal Telegram account of this installation's owner over MTProto: map out the account structure (folders, groups, archive), read any chats and their history, search across all messages, view and download attachments, pull chat participants with links to them, write and reply as the owner, manage chats, send warnings to the agent bot. Use when asked to find out, look up, break down, download or send something in Telegram.
...
the deadline: "remind me in two hours if he does not answer" is exactly
